...
type StudentStatusHistoryCreateFields = Required<Pick<StudentStatusHistory, 'student_id' | 'status_id' | 'changed_at'>>;
type StudentStatusHistoryUpdateFields = Pick<StudentStatusHistory, 'student_id' | 'status_id' | 'changed_at'>;
